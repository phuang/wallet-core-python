...
// Returns true if the object is a PyDerivationPathIndex.
bool PyDerivationPathIndex_Check(PyObject* object);

// Create PyDerivationPathIndex from an TWDerivationPathIndex.
PyObject* PyDerivationPathIndex_FromTWDerivationPathIndex(
    TWDerivationPathIndex* value);

// Get enum TWDerivationPathIndex value from a PyDerivationPathIndex object.
TWDerivationPathIndex* PyDerivationPathIndex_GetTWDerivationPathIndex(
    PyObject* object);

// Initialize for PyDerivationPathIndex. It is called by python module init
// function.
